...
/**
 * This class is tower information panel
 * @author Team3
 */
...
public class TowerInfoPanel extends JPanel 
{
	 ...
	 */
	public void displayTowerDetail (Tower tower) 
	{
		this.tower = tower;
		...
		speedLable.setForeground(Color.WHITE);
		...
		speedCount.setForeground(Color.WHITE);
		...
		powerLable.setForeground(Color.WHITE);
		...
		rangeLable.setForeground(Color.WHITE);
		...
		valueLable.setForeground(Color.WHITE);
		...
		while (keySetIterator.hasNext()) 
		{
			...
			switch (key) 
			{
				case "FirePower":
					...
					powerCount.setForeground(Color.WHITE);
					break;
				case "FireRange":
					rangeCount.setText((details.get(key)).toString());
					rangeCount.setForeground(Color.WHITE);
					break;
				case "FireSpeed":
		...
		valueCount.setForeground(Color.WHITE);
